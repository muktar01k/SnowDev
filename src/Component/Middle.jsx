    ...
    return (
        <div className="">
            <div className="">
                ...
                <p className='text-3xl text-center font-bold sm:text-2xl sm:w-[25rem] smxx:w-[20rem] smxx:ml-[1rem]'>We deliver Top Notch In Any Of This Range</p>
