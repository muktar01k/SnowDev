...
export const WelcomeText = ({ text2, text3, text4 }) => {
    return (
        <div className=" justify-center text-center mt-[5rem] h-[40rem] static md:h-[37rem]">
            <div className=" ">
                <h2 className='text-8xl font-Josefin Sans font-semibold sm:text-3xl pr-[2rem] md:text-5xl md:pl-[4rem]'>{text2} </h2>
                <h1 className='lg:text-8xl font-bold mt-[1rem] sm:text-6xl pr-[2rem] md:text-5xl md:pl-[4rem]'>{text3}</h1>
            </div>

            <p className=' ml-[9rem] text-[grey] font-medium sm:mt-[2rem] sm:text-xl sm:w-[25rem] sm:ml-[0.5rem] md:w-[45rem] md:text-2xl md:ml-[2.5rem] '>{text4}</p>

            <div className="justify-center gap-[8rem] mt-[1rem] flex  md:flex md:gap-[4rem] md:justify-center">
